package com.example.heavyduty.presentation.view.screens.tracker.workoutLogBook.addWorkout
...
fun AddWorkoutPrompt(){
    ...
    )
    {
        Column(
            ...
            Text(text = "Workout 1", color = Color.White)
        }

        Column {
            Text(text = "Workout Name", color = Color.White)
            TextField(
                value = "",
                onValueChange = {},
