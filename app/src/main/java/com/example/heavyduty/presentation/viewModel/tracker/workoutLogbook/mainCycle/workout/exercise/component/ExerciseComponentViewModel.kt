...
@Inject constructor(
    ...
    private val exerciseScreenUIState: ExerciseScreenUIState
) : ViewModel()
{
    ...
    private fun updateState() {
        viewModelScope.launch {
            exerciseList = workoutLogbookOfflineRepository.getExerciseList(exerciseScreenUIState.workoutIndex, exerciseScreenUIState.cycleIndex)
        }
